...
module.exports = {
  ...
  sprites: {
    ...
    options: {
      ...
      imgPath: '/_assets/images/sprites/icon-sprite.png'
    }
  },
  optimize: {
    css: {
    ...
    images: {
      src:  developmentAssets + '/images/**/*.{jpg,jpeg,png,gif,ico}',
      dest: productionAssets + '/images/',
      options: {
        optimizationLevel: 3,
        progessive: true,
  ...
  rsync: {
    src: production + '/**',
    options: {
      destination: '/var/www/html/southerneer/',
      root: production,
      hostname: 'southerneer2.cloudapp.net',
      username: 'azureuser',
      incremental: true,
      progress: true,
      relative: true,
